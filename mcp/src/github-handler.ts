...
app.get("/authorize", async (c) => {
	...
	return renderApprovalDialog(c.req.raw, {
		...
		server: {
			description:
				"Berkehan finansal takip sistemi. Kartlari okur; analiz, karar ve " +
				"veri duzeltmelerini bir PR olarak sunar. Dogrudan main'e yazmaz.",
	...
	return new Response(null, {
		headers: {
			...
			location: getUpstreamAuthorizeUrl({
				...
				// public_repo, PR acmak ve claude_inbox'a commit atmak icin gerekli.
				// Tam 'repo' kapsami ISTENMEZ: depo zaten public, ozel depolara
				// erisim vermenin bir sebebi yok.
